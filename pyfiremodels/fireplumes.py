...
if __name__ == "__main__":
    ...
    Q = 7000#1.5*7000 #13400*3 #35000
    
    Qs = [1000, 1500, 2500, 5000]
    plt.figure(figsize=(12,8))
    for i, Q in enumerate(Qs):
        Tamb = 20 + 273.15
        zs = np.linspace(0, 4.4, 101)
    ...
    plt.plot([538, 538], [0,4.4/0.3048], '--k', linewidth=lw, label='Failure')
    
    plt.grid()
    plt.xlabel("Gas Temperature (C)", fontsize=fs)
    plt.ylabel("Height Above Fire (ft))", fontsize=fs)
